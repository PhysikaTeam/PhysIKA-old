/*
* @file tri_mesh_render_task_test.cpp
...
#include "Physika_Render/Volumetric_Mesh_Render/Tri_Mesh_Render/tri_mesh_render_util.h"
#include "Physika_Render/Volumetric_Mesh_Render/Tri_Mesh_Render/tri_mesh_point_render_task.h"
#include "Physika_Render/Volumetric_Mesh_Render/Tri_Mesh_Render/tri_mesh_point_vector_render_task.h"
#include "Physika_Render/Volumetric_Mesh_Render/Tri_Mesh_Render/tri_mesh_wireframe_render_task.h"
#include "Physika_Render/Volumetric_Mesh_Render/Tri_Mesh_Render/tri_mesh_solid_render_task.h"
...
void initFunction()
{
    ...
    auto render_util = make_shared<TriMeshRenderUtil<double>>(mesh);
    //---------------------------------------------------------------------------------------------------------------------

    //---------------------------------------------------------------------------------------------------------------------
    auto wireframe_render_task = make_shared<TriMeshWireframeRenderTask<double>>(render_util);
    render_scene_config.pushBackRenderTask(wireframe_render_task);

    //---------------------------------------------------------------------------------------------------------------------
    auto solid_render_task = make_shared<TriMeshSolidRenderTask<double>>(render_util);
    render_scene_config.pushBackRenderTask(solid_render_task);

    //---------------------------------------------------------------------------------------------------------------------
    auto point_render_task = make_shared<TriMeshPointRenderTask<double>>(render_util);
    //render_scene_config.pushBackRenderTask(point_render_task);

    //---------------------------------------------------------------------------------------------------------------------
    auto point_vector_render_task = make_shared<TriMeshPointVectorRenderTask<double>>(render_util);
