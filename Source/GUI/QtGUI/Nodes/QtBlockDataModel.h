...
public:
    ...
    virtual ~QtBlockDataModel() = default;
...
public:
    ...
    virtual BlockDataType dataType(PortType portType, PortIndex portIndex) const = 0;
...
public:
    ...
    virtual std::shared_ptr<BlockData>
    ...
    virtual BlockPainterDelegate* painterDelegate() const
    {
        return nullptr;
    }
