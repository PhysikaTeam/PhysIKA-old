    ...
    for (PortType portToCheck : { PortType::In, PortType::Out })
    {
        ...
        if (portIndex != INVALID)
        {
            ...
            if (portToCheck == PortType::In)
            {
                ...
                if (!connections.empty() && inPolicy == QtBlockDataModel::ConnectionPolicy::One)
                {
            ...
            else  // initialize new Connection
            {
                ...
                if (!connections.empty() && outPolicy == QtBlockDataModel::ConnectionPolicy::One)
                {
