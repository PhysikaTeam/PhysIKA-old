    ...
    , _nodeGraphicsObject(nullptr)
{
    ...
    connect(_nodeDataModel.get(), &QtBlockDataModel::dataUpdated, this, &QtBlock::onDataUpdated);

    connect(_nodeDataModel.get(), &QtBlockDataModel::embeddedWidgetSizeUpdated, this, &QtBlock::onNodeSizeUpdated);
}
