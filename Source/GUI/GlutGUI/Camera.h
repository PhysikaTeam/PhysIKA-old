...
namespace PhysIKA
{
    ...
    public:
        ...
        */
        ...
        void setWorldUp(const Vector3f& worldup) { m_worldUp = worldup; }
        void setLocalView(const Vector3f& localview) { m_localView = localview; }
        void setLocalRight(const Vector3f& localright) { m_localRight = localright; }
        void setLocalUp(const Vector3f& localup) { m_localUp = localup; }
