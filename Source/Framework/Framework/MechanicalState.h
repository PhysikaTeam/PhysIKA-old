...
public:
    ...
    */
    static FieldID position()
    {
        return "position";
    }
    static FieldID pre_position()
    {
        return "pre_position";
    }
    static FieldID init_position()
    {
        return "init_position";
    }

    static FieldID velocity()
    {
        return "velocity";
    }
    static FieldID pre_velocity()
    {
        return "pre_velocity";
    }

    static FieldID angularVelocity()
    {
        return "angular_velocity";
    }

    static FieldID acceleration()
    {
        return "acceleration";
    }

    static FieldID force()
    {
        return "force";
    }
    static FieldID torque()
    {
        return "force_moment";
    }
    ...
    static FieldID angularMass()
    {
        return "angular_mass";
    }
    static FieldID rotation()
    {
        return "rotation";
    }
    ...
    */
    static FieldID density()
    {
        return "density";
    }
    static FieldID volume()
    {
        return "volume";
    }
    static FieldID particle_neighbors()
    {
        return "particle_neighbors";
    }
    static FieldID particle_attribute()
    {
        return "particle_attribute";
    }
    static FieldID particle_normal()
    {
        return "particle_normal";
    }

    static FieldID reference_particles()
    {
