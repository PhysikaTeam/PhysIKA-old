...
COMM_FUNC TPointSweep3D<Real>::TPointSweep3D(TPoint3D<Real>& start, TPoint3D<Real>& end)
{
    start_point = start;
    end_point   = end;
}
...
template <typename Real>
COMM_FUNC TPointSweep3D<Real>::TPointSweep3D(const TPointSweep3D& point_sweep)
{
...
template <typename Real>
COMM_FUNC int TPointSweep3D<Real>::intersect(const TTriangleSweep3D<Real>& triangle_sweep, typename TTriangle3D<Real>::Param& baryc, Real& t, Real threshold) const
{
    t              = -Real(1);
...
template <typename Real>
COMM_FUNC TPoint3D<Real> TPointSweep3D<Real>::interpolate(Real t) const
{
    TPoint3D<Real> point;
...
template <typename Real>
COMM_FUNC TTriangleSweep3D<Real>::TTriangleSweep3D(TTriangle3D<Real>& start, TTriangle3D<Real>& end)
{
...
template <typename Real>
COMM_FUNC TTriangleSweep3D<Real>::TTriangleSweep3D(const TTriangleSweep3D& triangle_sweep)
{
...
template <typename Real>
COMM_FUNC TTriangle3D<Real> TTriangleSweep3D<Real>::interpolate(Real t) const
{
    Real t0 = t;
    Real t1 = 1 - t;
