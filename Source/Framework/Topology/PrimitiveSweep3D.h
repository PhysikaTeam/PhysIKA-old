...
{
public:
    COMM_FUNC TPointSweep3D(TPoint3D<Real>& start, TPoint3D<Real>& end);
    COMM_FUNC TPointSweep3D(const TPointSweep3D& point_sweep);
    ...
    /**
         ...
         * @param t 
         * @return COMM_FUNC intersect 
         */
    COMM_FUNC int intersect(const TTriangleSweep3D<Real>& triangle_sweep, typename TTriangle3D<Real>::Param& baryc, Real& t, Real threshold = Real(0.0001)) const;
    ...
    /**
         ...
         */
    COMM_FUNC TPoint3D<Real> interpolate(Real t) const;
...
{
public:
    COMM_FUNC TTriangleSweep3D(TTriangle3D<Real>& start, TTriangle3D<Real>& end);
    COMM_FUNC TTriangleSweep3D(const TTriangleSweep3D& triangle_sweep);
    ...
    /**
         ...
         */
    COMM_FUNC TTriangle3D<Real> interpolate(Real t) const;
