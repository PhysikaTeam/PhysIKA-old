...
template <typename TDataType>
void PhysIKA::HeightField<TDataType>::setSpace(Real dx, Real dz)
{
    m_dx = dx;
    m_dz = dz;
}
...
template <typename TDataType>
void PhysIKA::HeightField<TDataType>::scale(Coord s)
{
    //cuExecute(m_coords.size(), PS_Scale, m_coords, s);
}
...
template <typename TDataType>
void PhysIKA::HeightField<TDataType>::translate(Coord t)
{
