...
struct PlusFunc
{
    /*! Function call operator. The return value is <tt>lhs + rhs</tt>.
        */
    COMM_FUNC inline T operator()(const T lhs, const T rhs) const
    {
        return lhs + rhs;
    }
};  // end plus
...
struct NegateFunc
{
    /*! Function call operator. The return value is <tt>-x</tt>.
        */
    COMM_FUNC inline T operator()(const T x) const
    {
        return -x;
    }
};  // end negate
...
struct EqualFunc
{
    /*! Function call operator. The return value is <tt>lhs == rhs</tt>.
        */
    COMM_FUNC inline bool operator()(const T lhs, const T rhs) const
    {
        return lhs == rhs;
    }
};  // end equal_to
...
struct LogicalNotFunc
{
    /*! Function call operator. The return value is <tt>!x</tt>.
        */
    COMM_FUNC inline bool operator()(const T& x) const
    {
        return !x;
    }
};  // end logical_not
