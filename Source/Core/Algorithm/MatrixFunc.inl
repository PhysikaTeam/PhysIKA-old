...
COMM_FUNC void polarDecomposition(const SquareMatrix<Real, 3>& A, SquareMatrix<Real, 3>& R, SquareMatrix<Real, 3>& U, SquareMatrix<Real, 3>& D, SquareMatrix<Real, 3>& V)
{
    ...
    svd(A(0, 0), A(0, 1), A(0, 2), A(1, 0), A(1, 1), A(1, 2), A(2, 0), A(2, 1), A(2, 2), U(0, 0), U(0, 1), U(0, 2), U(1, 0), U(1, 1), U(1, 2), U(2, 0), U(2, 1), U(2, 2), D(0, 0), D(1, 1), D(2, 2), V(0, 0), V(0, 1), V(0, 2), V(1, 0), V(1, 1), V(1, 2), V(2, 0), V(2, 1), V(2, 2));
