...
COMM_FUNC MultiMap<MKey, T>::MultiMap()
{
}

template <typename MKey, typename T>
COMM_FUNC Pair<MKey, T>* MultiMap<MKey, T>::find(MKey key)
{
...
template <typename MKey, typename T>
COMM_FUNC Pair<MKey, T>* MultiMap<MKey, T>::insert(Pair<MKey, T> pair)
{
...
template <typename MKey, typename T>
COMM_FUNC T& MultiMap<MKey, T>::operator[](MKey key)
{
...
template <typename MKey, typename T>
COMM_FUNC const T& MultiMap<MKey, T>::operator[](MKey key) const
{
    Pair<MKey, T>* ret = find(key);
...
template <typename MKey, typename T>
COMM_FUNC void MultiMap<MKey, T>::clear()
{
    m_size = 0;
}

template <typename MKey, typename T>
COMM_FUNC size_t MultiMap<MKey, T>::size()
{
    return m_size;
}

template <typename MKey, typename T>
COMM_FUNC size_t MultiMap<MKey, T>::count(MKey key)
{
...
template <typename MKey, typename T>
COMM_FUNC bool MultiMap<MKey, T>::empty()
{
