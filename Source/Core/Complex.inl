...
COMM_FUNC Complex<Real>::Complex()
    : m_real(0.0), m_imag(0.0)
{
}

template <typename Real>
COMM_FUNC Complex<Real>::Complex(Real real, Real imag)
    : m_real(real), m_imag(imag)
{
}

template <typename Real>
COMM_FUNC const Complex<Real> Complex<Real>::operator+(const Complex<Real>& other) const
{
    Complex<Real> sum;
...
template <typename Real>
COMM_FUNC Complex<Real>& Complex<Real>::operator+=(const Complex<Real>& other)
{
...
template <typename Real>
COMM_FUNC Complex<Real>& Complex<Real>::operator*=(const Complex& other)
{
...
COMM_FUNC Complex<Real>& Complex<Real>::operator/=(const Complex<Real>& other)
{
    double a = (m_real * other.m_real + m_imag * other.m_imag) / (other.m_real * other.m_real + other.m_imag * other.m_imag);
...
template <typename Real>
COMM_FUNC bool Complex<Real>::operator==(const Complex<Real>& other) const
{
...
template <typename Real>
COMM_FUNC const Complex<Real> Complex<Real>::operator+(const Real& real) const
{
...
template <typename Real>
COMM_FUNC Complex<Real>& Complex<Real>::operator+=(const Real& real)
{
    m_real += real;
    return *this;
}
...
template <typename Real>
COMM_FUNC const Complex<Real> Complex<Real>::operator-(void) const
{
    Complex<Real> neg;
    neg.m_real = -m_real;
    neg.m_imag = -m_imag;
...
template <typename Real>
COMM_FUNC Complex<Real> Complex<Real>::conjugate() const
{
...
template <typename Real>
COMM_FUNC Real Complex<Real>::norm() const
{
    return glm::sqrt(m_real * m_real + m_imag * m_imag);
}

template <typename Real>
COMM_FUNC Real Complex<Real>::normSquared() const
{
...
template <typename Real>
COMM_FUNC bool Complex<Real>::isReal() const
{
...
template <class Real>
COMM_FUNC Complex<Real> sinh(const Complex<Real>& __x)
{
...
template <typename Real>
inline COMM_FUNC Real arg(const Complex<Real>& __c)
{
    return atan2(__c.imagPart(), __c.realPart());
}

template <typename Real>
inline COMM_FUNC Complex<Real> polar(const Real& __rho, const Real& __theta)
{
...
template <typename Real>
inline COMM_FUNC Complex<Real> log(const Complex<Real>& __x)
{
...
template <typename Real>
inline COMM_FUNC Complex<Real> log10(const Complex<Real>& __x)
{
...
template <typename Real>
inline COMM_FUNC Complex<Real> sqrt(const Complex<Real>& __x)
{
...
template <class Real>
COMM_FUNC Complex<Real> exp(const Complex<Real>& __x)
{
...
template <class Real>
inline COMM_FUNC Complex<Real> pow(const Complex<Real>& __x, const Complex<Real>& __y)
{
    return exp(__y * log(__x));
}

template <class Real>
inline COMM_FUNC Complex<Real> pow(const Complex<Real>& __x, const Real& __y)
{
    return pow(__x, Complex<Real>(__y));
}

template <class Real>
inline COMM_FUNC Complex<Real> pow(const Real& __x, const Complex<Real>& __y)
{
...
template <class Real>
COMM_FUNC Complex<Real> asinh(const Complex<Real>& __x)
{
...
template <class Real>
COMM_FUNC Complex<Real> cosh(const Complex<Real>& __x)
{
    if (isinf(__x.realPart()) && !isfinite(__x.imagPart()))
...
template <class Real>
COMM_FUNC Complex<Real> acosh(const Complex<Real>& __x)
{
    const Real __pi(atan2(+0., -0.));
    if (isinf(__x.realPart()))
    {
...
template <class Real>
COMM_FUNC Complex<Real> atanh(const Complex<Real>& __x)
{
    const Real __pi(atan2(+0., -0.));
    if (isinf(__x.imagPart()))
    {
...
template <class Real>
COMM_FUNC Complex<Real> tanh(const Complex<Real>& __x)
{
    if (isinf(__x.realPart()))
    {
...
template <class Real>
COMM_FUNC Complex<Real> asin(const Complex<Real>& __x)
{
...
template <class Real>
COMM_FUNC Complex<Real> acos(const Complex<Real>& __x)
{
    const Real __pi(atan2(+0., -0.));
    if (isinf(__x.realPart()))
    {
...
template <class Real>
COMM_FUNC Complex<Real> atan(const Complex<Real>& __x)
{
...
template <class Real>
COMM_FUNC Complex<Real> sin(const Complex<Real>& __x)
{
...
template <class Real>
inline COMM_FUNC Complex<Real> cos(const Complex<Real>& __x)
{
...
template <class Real>
COMM_FUNC Complex<Real> tan(const Complex<Real>& __x)
{
