...
namespace PhysIKA
{
    ...
    public:
        ...
        */
        ...
        void setBodyDirty() { m_bodyDataDirty = true; }
        ...
        */
        ...
        bool setJointDirty() { m_jontDataDirty = true; }

        Array<PBDJoint<double>>& getGPUJoints() { return m_GPUJoints; }
        const Array<PBDJoint<double>>& getGPUJoints()const { return m_GPUJoints; }

        std::vector<RigidBody2_ptr>& getRigidBodys() { return m_rigids; }
        const std::vector<RigidBody2_ptr>& getRigidBodys()const { return m_rigids; }

        std::vector<PBDBodyInfo<double>>& getCPUBody() { return m_CPUBodys; }
        const std::vector<PBDBodyInfo<double>>& getCPUBody()const { return m_CPUBodys; }

        Array<PBDBodyInfo<double>>& getGPUBody() { return m_GPUBodys; }
        const Array<PBDBodyInfo<double>>& getGPUBody()const { return m_GPUBodys; }
        ...
        */
        ...
        void setNarrowDetectionFun(DetectionFun fun) { m_narrowPhaseDetection = fun; }

        void setBroadDetectionFun(DetectionFun fun) { m_broadPhaseDetection = fun; }

        void synFromBodiedToRigid();

        void addCustomUpdateFunciton(CustomUpdateFun fun) { m_selfupdate.push_back(fun); }


        void enableVelocitySolve() { m_solveVelocity = true; }
        void disableVelocitySolve() { m_solveVelocity = false; }
