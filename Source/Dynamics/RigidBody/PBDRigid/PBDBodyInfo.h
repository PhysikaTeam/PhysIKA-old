...
namespace PhysIKA
{
	...
	*/
	...
	public:
		...
		*/
		COMM_FUNC Real getPBDInverseMass(const Vector<Real, 3>& normal, const Vector<Real, 3>& pos, 
			bool beposition = true)const 
		{
		...
		*/
		COMM_FUNC void applyCorrection(const Vector<Real, 3>& corr, const Vector<Real, 3>& pos,
			bool beposition, bool velocityLevel = false)
		{
