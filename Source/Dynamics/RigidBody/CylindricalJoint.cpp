...
namespace PhysIKA
{
	...
	CylindricalJoint::CylindricalJoint(std::string name): Joint(name)
	{
	}

	CylindricalJoint::CylindricalJoint(Node* predecessor, Node* successor) :Joint(predecessor, successor)
	{
	}
