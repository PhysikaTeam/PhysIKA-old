...
namespace PhysIKA
{
    ...
    VehicleFrontJoint::VehicleFrontJoint(std::string name):Joint(name)
    {
    }

    VehicleFrontJoint::VehicleFrontJoint(Node* predecessor, Node* successor) :Joint(predecessor, successor)
    {
    }
