...
void DensityPBD<TDataType>::takeOneIteration()
{
    ...
    {
        cuExecute(num, K_ComputeLambdas, m_lamda, m_summation->outDensity()->getValue(), this->inPosition()->getValue(), this->inNeighborIndex()->getValue(), m_kernel, this->varSmoothingLength()->getValue());

        cuExecute(num, K_ComputeDisplacement, m_deltaPos, m_lamda, this->inPosition()->getValue(), this->inNeighborIndex()->getValue(), m_kernel, this->varSmoothingLength()->getValue(), dt);
    }
    else
    {
        cuExecute(num, K_ComputeLambdas, m_lamda, m_summation->outDensity()->getValue(), this->inPosition()->getValue(), m_massInv.getValue(), this->inNeighborIndex()->getValue(), m_kernel, this->varSmoothingLength()->getValue());

        cuExecute(num, K_ComputeDisplacement, m_deltaPos, m_lamda, this->inPosition()->getValue(), m_massInv.getValue(), this->inNeighborIndex()->getValue(), m_kernel, this->varSmoothingLength()->getValue(), dt);
    }

    cuExecute(num, K_UpdatePosition, this->inPosition()->getValue(), this->inVelocity()->getValue(), m_deltaPos, dt);
}
...
void DensityPBD<TDataType>::updateVelocity()
{
    ...
    cuExecute(num, DP_UpdateVelocity, this->inVelocity()->getValue(), m_position_old, this->inPosition()->getValue(), dt);
}
