	...
	*/
	...
	public:
		...
		*/
		...
		int sampleCount() { return m_nx * m_ny * var_SampleFreq.getValue() * var_SampleFreq.getValue() *var_SampleLayer.getValue(); }
		...
		virtual void applyCustomBehavior() { compute(); }

		virtual bool initializeImpl()override { compute(); return true; }
