...
#include "FEMProblemIntegratedFastMsProblem.h"
...
template <typename T>
int fast_ms_builder<T>::update_problem(const T* x, const T* v)
{
...
template class fast_ms_builder<double>;

template class fast_ms_builder<float>;
