...
struct DiffScalarBase {
	 ...
	 */
	static inline void setVariableCount(int value) {
		m_variableCount = value;
	}

	/// Get the variable count used by the automatic differentiation layer
	static inline int getVariableCount() {
		return m_variableCount;
	}
	static int m_variableCount;
};

#define DECLARE_DIFFSCALAR_BASE()  int DiffScalarBase::m_variableCount = 0
