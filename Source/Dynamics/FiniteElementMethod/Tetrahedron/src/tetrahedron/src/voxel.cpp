...
{
    file<<"4 "<<" "<<vertice_index[0]<<" "<<vertice_index[1]<<" "<<vertice_index[5]<<" "<<vertice_index[7]<<std::endl;
    file<<"4 "<<" "<<vertice_index[0]<<" "<<vertice_index[1]<<" "<<vertice_index[3]<<" "<<vertice_index[7]<<std::endl;
    file<<"4 "<<" "<<vertice_index[0]<<" "<<vertice_index[4]<<" "<<vertice_index[5]<<" "<<vertice_index[7]<<std::endl;
    file<<"4 "<<" "<<vertice_index[0]<<" "<<vertice_index[4]<<" "<<vertice_index[6]<<" "<<vertice_index[7]<<std::endl;
    file<<"4 "<<" "<<vertice_index[0]<<" "<<vertice_index[2]<<" "<<vertice_index[3]<<" "<<vertice_index[7]<<std::endl;
    file<<"4 "<<" "<<vertice_index[0]<<" "<<vertice_index[2]<<" "<<vertice_index[6]<<" "<<vertice_index[7]<<std::endl;
}
...
{
    return (abs(int(voxel_1.coord_index[0])-int(voxel_2.coord_index[0]))+
            abs(int(voxel_1.coord_index[1])-int(voxel_2.coord_index[1]))+
            abs(int(voxel_1.coord_index[2])-int(voxel_2.coord_index[2])));
}
