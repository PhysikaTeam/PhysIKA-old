...
public:
  ...
  virtual int get_edge_vert_info(size_t &id_v1, size_t &id_v2,
...
{
public:
  VertEdge(size_t id_v1, size_t id_v2,
...
{
public:
  VertLine(size_t id_tri, size_t axis_1, size_t id_grid_1,
...
{
public:
  VertGrid(size_t axis, size_t id_grid_1,
