...
int Vert::get_edge_vert_info(size_t &id_v1, size_t &id_v2,
                             size_t &axis, size_t &id_grid_line) const
{
...
int VertEdge::get_edge_vert_info(size_t &id_v1, size_t &id_v2,
                                 size_t &axis, size_t &id_grid_line) const
{
  id_v1 = id_v_[0];
  id_v2 = id_v_[1];
...
VertEdge::VertEdge(size_t id_v1, size_t id_v2,
                   size_t axis, size_t id_grid_line)
{
  id_v_[0] = id_v1;
  id_v_[1] = id_v2;
  axis_ = axis;
...
VertLine::VertLine(size_t id_tri, size_t axis_1, size_t id_grid_1,
                   size_t axis_2, size_t id_grid_2)
{
  axis_[0] = axis_1;
  axis_[1] = axis_2;
...
VertGrid::VertGrid(
  size_t axis, size_t id_grid_1,
  size_t axis_cut, size_t id_grid_2,
  size_t axis_projection, size_t id_grid_3)
{
  assert(axis < 3);
...
int Vert::get_line_vert_info(
  size_t &a1, size_t &a2, size_t &g1, size_t &g2, size_t &id_tri) const
{
