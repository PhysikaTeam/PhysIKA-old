...
// REAL *f;
// REAL *h;
int linear_expansion_sum_zerolim(int elen, REAL *e, int flen, REAL *f, REAL *h)
{
  REAL Q, q, hh;
  INEXACT REAL Qnew;
  INEXACT REAL R;
...
// REAL *pc;
// REAL detsum;
REAL orient2dadapt(REAL const *pa, REAL const *pb, REAL const *pc, REAL const detsum)
{
  INEXACT REAL acx, acy, bcx, bcy;
...
// REAL *pd;
// REAL permanent;
REAL orient3dadapt(REAL const *pa, REAL const *pb, REAL const *pc, REAL const * pd, REAL const permanent)
{
