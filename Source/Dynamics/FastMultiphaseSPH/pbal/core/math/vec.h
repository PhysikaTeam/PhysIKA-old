...
struct __vecbase {
  ...
  FLUID_CUDA_HOST_DEVICE __vecbase(Args...args) : data{(T)args...} {}
};
...
struct __vecbase<T, 2> {
  ...
  FLUID_CUDA_HOST_DEVICE __vecbase(){}
  FLUID_CUDA_HOST_DEVICE __vecbase(T x, T y) : data{x, y} {}
};
...
struct __vecbase<T, 3> {
  ...
  FLUID_CUDA_HOST_DEVICE __vecbase(){}
  FLUID_CUDA_HOST_DEVICE __vecbase(T x, T y, T z) : data{x, y, z} {}
};
...
struct __vecbase<T, 4> {
  ...
  FLUID_CUDA_HOST_DEVICE __vecbase(){}
  FLUID_CUDA_HOST_DEVICE __vecbase(T x, T y, T z, T w) : data{x, y, z, w} {}
};
...
struct cross_trait {
  ...
  using Result = struct {};
  FLUID_CUDA_HOST_DEVICE static Result cross(Operand a, Operand b) { return {}; }
};
...
struct Vec : __vecbase<T, size> {
  ...
  template<typename...Args>
  FLUID_CUDA_HOST_DEVICE Vec(Args...args) : __vecbase<T, size>(args...) {}
