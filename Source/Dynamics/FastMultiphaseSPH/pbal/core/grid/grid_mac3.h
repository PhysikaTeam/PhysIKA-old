    ...
    class GridMac3 {
        public:
            ...
            void resize(Size3 size, Vec3<T> spacing, Vec3<T> origin, T initVal = T()) {
                ...
                _spacing = spacing;
                _uOrigin = origin + Vec3<T>(
                    static_cast<T>(0.0),
                    static_cast<T>(0.5 * _spacing.y),
                    static_cast<T>(0.5 * _spacing.z)
                );
                _vOrigin = origin + Vec3<T>(
                    static_cast<T>(0.5 * _spacing.x),
                    static_cast<T>(0.0),
                    static_cast<T>(0.5 * _spacing.z)
                );
                _wOrigin = origin + Vec3<T>(
                    static_cast<T>(0.5 * _spacing.x),
                    static_cast<T>(0.5 * _spacing.y),
                    static_cast<T>(0.0)
                );
            ...
            Vec3<T> uPosition(int i, int j, int k) const {
                return _uOrigin + _spacing * Vec3<T>(
                        static_cast<T>(i),
                        static_cast<T>(j),
                        static_cast<T>(k));
            }
            ...
            Vec3<T> vPosition(int i, int j, int k) const {
                return _vOrigin + _spacing * Vec3<T>(
                        static_cast<T>(i),
                        static_cast<T>(j),
                        static_cast<T>(k));
            }
            ...
            Vec3<T> wPosition(int i, int j, int k) const {
                return _wOrigin + _spacing * Vec3<T>(
                        static_cast<T>(i),
                        static_cast<T>(j),
                        static_cast<T>(k));
            }
            ...
            Vec3<T> sample(const Vec3<T>& pt) const {
                auto uVal = ConstArrayPtr3<T>(_u.data(), _uSize).linearSample(
                    pt,
                    _spacing,
                    _uOrigin
                );
                auto vVal = ConstArrayPtr3<T>(_v.data(), _vSize).linearSample(
                    pt,
                    _spacing,
                    _vOrigin
                );
                auto wVal = ConstArrayPtr3<T>(_w.data(), _wSize).linearSample(
                    pt,
                    _spacing,
                    _wOrigin
                );
