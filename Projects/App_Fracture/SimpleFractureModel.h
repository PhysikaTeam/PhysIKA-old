...
namespace Physika
{
	...
	*/
	...
	class SimpleFractureModel : public NumericalModel
	{
		DECLARE_CLASS_1(SimpleFractureModel, TDataType)
	public:
		typedef typename TDataType::Real Real;
		typedef typename TDataType::Coord Coord;

		SimpleFractureModel();
		virtual ~SimpleFractureModel();
	...
	template class SimpleFractureModel<DataType3f>;
#else
	template class SimpleFractureModel<DataType3d>;
#endif
}