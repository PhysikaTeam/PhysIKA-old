/*
* @file tet_mesh_render_task_test.cpp
...
#include "Physika_Render/Volumetric_Mesh_Render/Tet_Mesh_Render/tet_mesh_render_util.h"
#include "Physika_Render/Volumetric_Mesh_Render/Tet_Mesh_Render/tet_mesh_point_render_task.h"
#include "Physika_Render/Volumetric_Mesh_Render/Tet_Mesh_Render/tet_mesh_point_vector_render_task.h"
#include "Physika_Render/Volumetric_Mesh_Render/Tet_Mesh_Render/tet_mesh_wireframe_render_task.h"
#include "Physika_Render/Volumetric_Mesh_Render/Tet_Mesh_Render/tet_mesh_solid_render_task.h"
...
void initFunction()
{
    ...
    auto render_util = make_shared<TetMeshRenderUtil<double>>(mesh);
    //---------------------------------------------------------------------------------------------------------------------

    //---------------------------------------------------------------------------------------------------------------------
    auto wireframe_render_task = make_shared<TetMeshWireframeRenderTask<double>>(render_util);
    //render_scene_config.pushBackRenderTask(wireframe_render_task);

    //---------------------------------------------------------------------------------------------------------------------
    auto solid_render_task = make_shared<TetMeshSolidRenderTask<double>>(render_util);
    //render_scene_config.pushBackRenderTask(solid_render_task);

    //---------------------------------------------------------------------------------------------------------------------
    auto point_render_task = make_shared<TetMeshPointRenderTask<double>>(render_util);
    render_scene_config.pushBackRenderTask(point_render_task);

    //---------------------------------------------------------------------------------------------------------------------
    auto point_vector_render_task = make_shared<TetMeshPointVectorRenderTask<double>>(render_util);
