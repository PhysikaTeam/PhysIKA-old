 ...
 * @date       : 2021-05-26
 * @description: dambreak scene with Barricade
...
void createScene()
{
    ...
    //Barricade
    auto barricade = std::make_shared<TriangularSurfaceMeshNode<DataType3f>>("barricade");
    barricade->getTriangleSet()->loadObjFile("../../Media/bowl/b3.obj");
    barricade->translate(Vector3f(0.1, 0.022, 0.5));
    auto sRenderf = std::make_shared<SurfaceMeshRender>();
    barricade->addVisualModule(sRenderf);
    ...
    sfi->addTriangularSurfaceMeshNode(barricade);
