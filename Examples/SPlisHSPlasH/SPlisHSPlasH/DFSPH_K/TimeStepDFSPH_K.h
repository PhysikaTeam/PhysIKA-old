#ifndef __TimeStepDFSPH_K_h__
#define __TimeStepDFSPH_K_h__
...
namespace SPH
{
	...
	*/
	class TimeStepDFSPH_K : public TimeStep
	{
	protected:
		SimulationDataDFSPH_K m_simulationData;
		Kmeans m_kmeans;
		...
		unsigned int m_curSubstep;
		unsigned int m_maxSubsteps;
		float m_partitionThreshold;
		bool m_lastStepPerformKmeans;
		Real m_epsilon;
