...
int BT_elementWithElastic(int **gix, double **gx, double **gv, double **gtk,
                          double dt,int icyc, int mg, int llkt, double qhg,
              double **gff,double **gfm)
{
    #define lg 64
    #define LLKT 3
