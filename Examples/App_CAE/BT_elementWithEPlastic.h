...
void bt_ep(int (*gix)[NUMEL], double (*gx)[NUMNP], double (*gv)[NUMNP], double dt,int icyc,
         double (*ff)[NUMNP],double (*fm)[NUMNP],
         double (*gsig1)[NUMEL],double (*gsig2)[NUMEL],double (*gsig3)[NUMEL],double (*gsig4)[NUMEL],double (*gsig5)[NUMEL],double (*gsig6)[NUMEL],double (*qs)[NUMEL],
         double (*plsn1)[NUMEL],double (*plsn2)[NUMEL],double (*plsn4)[NUMEL],double (*xp_ep)[NUMEL])
{
    #define lg 64
...
//Izero
    ...
    {
        for (int j=0; j<6; j++) ggw[iggw][j]=0.0E0;
    }
