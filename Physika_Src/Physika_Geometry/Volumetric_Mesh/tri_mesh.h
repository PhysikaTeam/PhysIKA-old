...
#ifndef PHYSIKA_GEOMETRY_VOLUMETRIC_MESH_TRI_MESH_H_
#define PHYSIKA_GEOMETRY_VOLUMETRIC_MESH_TRI_MESH_H_
...
#endif //PHYSIKA_GEOMETRY_VOLUMETRIC_MESH_TRI_MESH_H_
