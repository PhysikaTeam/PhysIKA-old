...
#ifndef PHYSIKA_GEOMETRY_BOUNDING_VOLUMES_BOUNDING_VOLUME_KDOP18_H_
#define PHYSIKA_GEOMETRY_BOUNDING_VOLUMES_BOUNDING_VOLUME_KDOP18_H_
...
#endif  //PHYSIKA_GEOMETRY_BOUNDING_VOLUMES_BOUNDING_VOLUME_KDOP18_H_
