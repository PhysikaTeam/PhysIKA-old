...
#ifndef PHYSIKA_GEOMETRY_BOUNDING_VOLUMES_BOUNDING_VOLUME_H_
#define PHYSIKA_GEOMETRY_BOUNDING_VOLUMES_BOUNDING_VOLUME_H_
...
#endif  //PHYSIKA_GEOMETRY_BOUNDING_VOLUMES_BOUNDING_VOLUME_H_