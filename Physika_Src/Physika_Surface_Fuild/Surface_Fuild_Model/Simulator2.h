#ifndef PHYSIKA_SURFACE_FUILD_SURFACE_FUILD_MODEL_SIMULATOR2_H_
#define PHYSIKA_SURFACE_FUILD_SURFACE_FUILD_MODEL_SIMULATOR2_H_
namespace Physika{
class Simulator2:public SimulationBase{
public:
Simulator2();
~Simulator2();
...
void post_data ();
void clear();
Simulator2(Simulator2 const &);
Simulator2 &operator=(Simulator2 const &);
