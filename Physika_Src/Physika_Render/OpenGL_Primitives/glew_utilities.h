...
inline bool openGLSetShaderVec2(int shader_id, const std::string & name, const Vector<Scalar, 2> & val)
{
...
template <typename Scalar>
inline bool openGLSetShaderVec3(int shader_id, const std::string & name, const Vector<Scalar, 3> & val)
{
...
template <typename Scalar>
inline bool openGLSetShaderCol3(int shader_id, const std::string & name, const Color<Scalar> & val)
{
    glm::vec3 glm_col = { val.redChannel(), val.greenChannel(), val.blueChannel() };
    return openGLSetShaderVec3(shader_id, name, glm_col);
}
...
template <typename Scalar>
inline bool openGLSetShaderVec4(int shader_id, const std::string & name, const Vector<Scalar, 4> & val)
{
...
template <typename Scalar>
inline bool openGLSetShaderCol4(int shader_id, const std::string & name, const Color<Scalar> & val)
{
    glm::vec4 glm_col = { val.redChannel(), val.greenChannel(), val.blueChannel(), val.alphaChannel() };
    return openGLSetShaderVec4(shader_id, name, glm_col);
}
...
template <typename Scalar>
inline bool openGLSetShaderMat2(int shader_id, const std::string & name, const SquareMatrix<Scalar, 2> & val)
{
...
template <typename Scalar>
inline bool openGLSetShaderMat3(int shader_id, const std::string & name, const SquareMatrix<Scalar, 3> & val)
{
...
template <typename Scalar>
inline bool openGLSetShaderMat4(int shader_id, const std::string & name, const SquareMatrix<Scalar, 4> & val)
{
...
template <typename Scalar>
inline bool openGLSetCurBindShaderVec2(const std::string & name, const Vector<Scalar, 2> & val)
{
    int cur_shader_id = openGLGetCurBindShaderID();
    return openGLSetShaderVec2(cur_shader_id, name, val);
}
...
template <typename Scalar>
inline bool openGLSetCurBindShaderVec3(const std::string & name, const Vector<Scalar, 3> & val)
{
    int cur_shader_id = openGLGetCurBindShaderID();
    return openGLSetShaderVec3(cur_shader_id, name, val);
}
...
template <typename Scalar>
inline bool openGLSetCurBindShaderCol3(const std::string & name, const Color<Scalar> & val)
{
    int cur_shader_id = openGLGetCurBindShaderID();
    return openGLSetShaderCol3(cur_shader_id, name, val);
}
...
template <typename Scalar>
inline bool openGLSetCurBindShaderVec4(const std::string & name, const Vector<Scalar, 4> & val)
{
    int cur_shader_id = openGLGetCurBindShaderID();
    return openGLSetShaderVec4(cur_shader_id, name, val);
}
...
template <typename Scalar>
inline bool openGLSetCurBindShaderCol4(const std::string & name, const Color<Scalar> & val)
{
    int cur_shader_id = openGLGetCurBindShaderID();
    return openGLSetShaderCol4(cur_shader_id, name, val);
}
...
template <typename Scalar>
inline bool openGLSetCurBindShaderMat2(const std::string & name, const SquareMatrix<Scalar, 2> & val)
{
    int cur_shader_id = openGLGetCurBindShaderID();
    return openGLSetShaderMat2(cur_shader_id, name, val);
}
...
template <typename Scalar>
inline bool openGLSetCurBindShaderMat3(const std::string & name, const SquareMatrix<Scalar, 3> & val)
{
    int cur_shader_id = openGLGetCurBindShaderID();
    return openGLSetShaderMat3(cur_shader_id, name, val);
}
...
template <typename Scalar>
inline bool openGLSetCurBindShaderMat4(const std::string & name, const SquareMatrix<Scalar, 4> & val)
{
    int cur_shader_id = openGLGetCurBindShaderID();
    return openGLSetShaderMat4(cur_shader_id, name, val);
}
