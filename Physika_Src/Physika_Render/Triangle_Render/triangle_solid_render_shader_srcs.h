/*
* @file triangle_solid_render_shader_srcs.h
* @Brief GLSL shaders for surface mesh
* @author Wei Chen
*
...
static const char * triangle_solid_render_vertex_shader = "#version 330 core\n" STRINGIFY(
...
static const char * triangle_solid_render_frag_shader = "#version 330 core\n" STRINGIFY(
...
void main()
{
    ...
    {
        total_light_color = vec3(1.0);
    } 

    if (use_custom_color)
        total_light_color *= frag_vert_col;

    if (use_tex && has_tex)
        total_light_color *= texture(tex, frag_tex_coord).rgb;
