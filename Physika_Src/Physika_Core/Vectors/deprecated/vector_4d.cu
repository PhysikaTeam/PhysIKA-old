...
CPU_GPU_FUNC_DECL Vector<Scalar,4>::Vector()
    :Vector(0) //delegating ctor
{
}

template <typename Scalar>
CPU_GPU_FUNC_DECL Vector<Scalar, 4>::Vector(Scalar x)
    : Vector(x, x, x, x) //delegating ctor
{
}

template <typename Scalar>
CPU_GPU_FUNC_DECL Vector<Scalar,4>::Vector(Scalar x, Scalar y, Scalar z, Scalar w)
    :data_(x, y, z, w)
{
}

template <typename Scalar>
CPU_GPU_FUNC_DECL Scalar& Vector<Scalar,4>::operator[] (unsigned int idx)
{
...
template <typename Scalar>
CPU_GPU_FUNC_DECL const Vector<Scalar,4> Vector<Scalar,4>::operator+ (const Vector<Scalar,4> &vec2) const
{
    return Vector<Scalar, 4>(*this) += vec2;
}

template <typename Scalar>
CPU_GPU_FUNC_DECL Vector<Scalar,4>& Vector<Scalar,4>::operator+= (const Vector<Scalar,4> &vec2)
{
    data_ += vec2.data_;
    return *this;
}
...
template <typename Scalar>
CPU_GPU_FUNC_DECL bool Vector<Scalar,4>::operator== (const Vector<Scalar,4> &vec2) const
{
...
template <typename Scalar>
CPU_GPU_FUNC_DECL const Vector<Scalar, 4> Vector<Scalar, 4>::operator+(Scalar value) const
{
    return Vector<Scalar, 4>(*this) += value;
}

template <typename Scalar>
CPU_GPU_FUNC_DECL Vector<Scalar, 4>& Vector<Scalar, 4>::operator+= (Scalar value)
{
    data_ += value;
    return *this;
}
...
template <typename Scalar>
CPU_GPU_FUNC_DECL const Vector<Scalar,4> Vector<Scalar,4>::operator* (Scalar scale) const
{
...
template <typename Scalar>
CPU_GPU_FUNC_DECL const Vector<Scalar, 4> Vector<Scalar, 4>::operator-(void) const
{
    Vector<Scalar, 4> res;
    res.data_ = -data_;
    return res;
...
template <typename Scalar>
CPU_GPU_FUNC_DECL Scalar Vector<Scalar,4>::norm() const
{
    return glm::length(data_);
}

template <typename Scalar>
CPU_GPU_FUNC_DECL Scalar Vector<Scalar,4>::normSquared() const
{
    return glm::length2(data_);
}

template <typename Scalar>
CPU_GPU_FUNC_DECL Vector<Scalar,4>& Vector<Scalar,4>::normalize()
{
...
template <typename Scalar>
CPU_GPU_FUNC_DECL Scalar Vector<Scalar,4>::dot(const Vector<Scalar,4>& vec2) const
{
