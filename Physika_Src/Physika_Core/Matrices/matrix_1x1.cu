...
CPU_GPU_FUNC_DECL SquareMatrix<Scalar,1>::SquareMatrix()
    :SquareMatrix<Scalar, 1>(0) //delegating ctor
{
}

template <typename Scalar>
CPU_GPU_FUNC_DECL SquareMatrix<Scalar,1>::SquareMatrix(Scalar value)
    :data_(value)
{
}

template <typename Scalar>
CPU_GPU_FUNC_DECL Scalar& SquareMatrix<Scalar,1>::operator() (unsigned int i, unsigned int j)
{
...
template <typename Scalar>
CPU_GPU_FUNC_DECL const Vector<Scalar,1> SquareMatrix<Scalar,1>::rowVector(unsigned int i) const
{
    Scalar val = (*this)(i,i);
...
template <typename Scalar>
CPU_GPU_FUNC_DECL const Vector<Scalar,1> SquareMatrix<Scalar,1>::colVector(unsigned int i) const
{
    Scalar val = (*this)(i,i);
    return Vector<Scalar,1>(val);
}
...
template <typename Scalar>
CPU_GPU_FUNC_DECL const SquareMatrix<Scalar,1> SquareMatrix<Scalar,1>::operator+ (const SquareMatrix<Scalar,1> &mat2) const
{
    return SquareMatrix<Scalar,1>(*this) += mat2;
}

template <typename Scalar>
CPU_GPU_FUNC_DECL SquareMatrix<Scalar,1>& SquareMatrix<Scalar,1>::operator+= (const SquareMatrix<Scalar,1> &mat2)
{
    data_ += mat2.data_;
    return *this;
}
...
template <typename Scalar>
CPU_GPU_FUNC_DECL bool SquareMatrix<Scalar,1>::operator== (const SquareMatrix<Scalar,1> &mat2) const
{
...
template <typename Scalar>
CPU_GPU_FUNC_DECL const SquareMatrix<Scalar,1> SquareMatrix<Scalar,1>::operator* (Scalar scale) const
{
...
template <typename Scalar>
CPU_GPU_FUNC_DECL const Vector<Scalar,1> SquareMatrix<Scalar,1>::operator* (const Vector<Scalar,1> &vec) const
{
...
template <typename Scalar>
CPU_GPU_FUNC_DECL const SquareMatrix<Scalar, 1> SquareMatrix<Scalar, 1>::operator- (void) const
{
...
template <typename Scalar>
CPU_GPU_FUNC_DECL const SquareMatrix<Scalar,1> SquareMatrix<Scalar,1>::transpose() const
{
...
template <typename Scalar>
CPU_GPU_FUNC_DECL Scalar SquareMatrix<Scalar,1>::determinant() const
{
    return data_;
}

template <typename Scalar>
CPU_GPU_FUNC_DECL Scalar SquareMatrix<Scalar,1>::trace() const
{
    return data_;
}

template <typename Scalar>
CPU_GPU_FUNC_DECL Scalar SquareMatrix<Scalar,1>::doubleContraction(const SquareMatrix<Scalar,1> &mat2) const
{
    Scalar result = 0;
...
template <typename Scalar>
CPU_GPU_FUNC_DECL Scalar SquareMatrix<Scalar,1>::frobeniusNorm() const
{
    return glm::abs(data_);
}

template <typename Scalar>
CPU_GPU_FUNC_DECL const SquareMatrix<Scalar,1> SquareMatrix<Scalar,1>::identityMatrix()
{
